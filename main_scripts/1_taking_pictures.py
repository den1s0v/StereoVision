...
from user_settings import total_photos
...
def TakePictures():
    ...
    if val.lower() == "y":
        ...
        while counter <= total_photos:
            ...
            t1 = datetime.now()
            countdown_timer = countdown - int((t1 - t2).total_seconds() * 2) / 2
            ...
            if left_grabbed and right_grabbed:
                ...
                text = '{} / {}'.format(str(countdown_timer).replace('.0',''), counter)
                cv2.putText(images, text, (50, 50), font, 2.0, (0, 0, 255), 4, cv2.LINE_AA)
